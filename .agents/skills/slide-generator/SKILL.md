...
- Never install dependencies or create `node_modules/`.
...
- Save draft source content as `examples/<name>.md` only if that file does not exist.
- If the target markdown file exists, create a new filename instead, for example `examples/<name>-v2.md`.
